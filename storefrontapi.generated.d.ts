...
export type MasterProductsQueryVariables = StorefrontAPI.Exact<{
...
export type MasterCustomProductItemFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type MasterCustomCollectionsQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
  xinpeiHandle: StorefrontAPI.Scalars['String']['input'];
  zhouHandle: StorefrontAPI.Scalars['String']['input'];
  productsFirst: StorefrontAPI.Scalars['Int']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type MasterCustomCollectionsQuery = {
  xinpei?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  #graphql\n  fragment MoneyProductItem on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment ProductItem on Product {\n    id\n    handle\n    title\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        ...MoneyProductItem\n      }\n      maxVariantPrice {\n        ...MoneyProductItem\n      }\n    }\n  }\n\n  query MasterProducts(\n    $first: Int!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    products(first: $first) {\n      nodes {\n        ...ProductItem\n      }\n    }\n  }\n': {
    return: MasterProductsQuery;
    variables: MasterProductsQueryVariables;
  };
  ...
  '#graphql\n  fragment MasterCustomProductItem on Product {\n    id\n    handle\n    title\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n      maxVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n  }\n  query MasterCustomCollections(\n    $first: Int!\n    $xinpeiHandle: String!\n    $zhouHandle: String!\n    $productsFirst: Int!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    xinpei: collection(handle: $xinpeiHandle) {\n      handle\n      title\n      products(first: $first) {\n        nodes {\n          ...MasterCustomProductItem\n        }\n      }\n    }\n    zhou: collection(handle: $zhouHandle) {\n      handle\n      title\n      products(first: $first) {\n        nodes {\n          ...MasterCustomProductItem\n        }\n      }\n    }\n    products(first: $productsFirst) {\n      nodes {\n        ...MasterCustomProductItem\n      }\n    }\n  }\n': {
    return: MasterCustomCollectionsQuery;
    variables: MasterCustomCollectionsQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
